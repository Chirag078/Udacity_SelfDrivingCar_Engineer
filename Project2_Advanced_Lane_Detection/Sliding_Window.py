...
def find_lane_pixels(binary_warped):
    ...
    for window in range(nwindows):
        ...
        win_xleft_low = leftx_current - margin  # Updated
        win_xleft_high = leftx_current + margin  # updated
        win_xright_low = rightx_current - margin  # updated
        win_xright_high = rightx_current + margin  # Updated
...
def FitPlynomial(binary_warped):
